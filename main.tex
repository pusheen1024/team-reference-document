...
\begin{itemize}
\item Swap two neighbouring elements "--- number of inversions;
\item Swap any two elements "--- n minus number of cycles;
\item Insert any element on another position "--- n minus LIS length;
\end{itemize}
